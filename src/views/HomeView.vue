          ...
          <ul class="mt-6 space-y-5">
            ...
            <li class="flex items-start gap-x-2.5">
              ...
              <p class="font-light">
                ...
                <a class="text-indigo-dye font-semibold" href="https://infonl.mx/" target="_blank">Instituto Estatal de
  ...
  <div class="py-12 bg-white-2">
    <div class="u-container">
      <div class="flex flex-wrap justify-center xl:flex-nowrap gap-5">
        ...
        <div class="xl:w-1/6 max-w-[184px] h-[100px]">
          <a class="grid place-items-center p-5 bg-white h-full rounded-[10px] u-shadow" href="/">
            <img src="/images/home/logo-datos-personales-derechos-arco.svg" alt="logo datos personales derechos arco" />
          </a>
        </div>
        <div class="xl:w-1/6 max-w-[184px] h-[100px]">
          <a class="grid place-items-center p-5 bg-white h-full rounded-[10px] u-shadow" href="/">
