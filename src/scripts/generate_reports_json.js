...
try {
  ...
  reportJsonData.forEach((element) => {
    ...
    const isDuplicate = processedReports.some(
      (existingReport) =>
        existingReport.title === report.title &&
        existingReport.description === report.description &&
        existingReport.link === report.link &&
        existingReport.conservation_of_information ===
          report.conservation_of_information &&
        existingReport.periodicity_of_information ===
          report.periodicity_of_information &&
        ...
        existingReport.name_of_the_public_citizen_consultation ===
          report.name_of_the_public_citizen_consultation &&
        existingReport.link_of_the_public_citizen_consultation ===
          report.link_of_the_public_citizen_consultation &&
